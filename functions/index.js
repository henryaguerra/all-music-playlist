...
const { getSpotifyPlaylist, getSpotifyTokens } = require("./handlers/spotify");
...
// Spotify http trigger
app.get("/spotify", getSpotifyPlaylist);
app.post("/getSpotifyTokens", getSpotifyTokens);
// app.post("/playSong", )
